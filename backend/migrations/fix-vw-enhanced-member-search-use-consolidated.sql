-- Fix vw_enhanced_member_search to use members_consolidated table
-- This fixes the issue where the members list shows 508,869 members instead of 552,267
-- because the view was querying the old 'members' table instead of 'members_consolidated'
