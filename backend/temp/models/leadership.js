...
class LeadershipModel {
    ...
    static async getLeadershipStructures() {
      ...
      `;
            ...
            throw (0, errorHandler_1.createDatabaseError)('Failed to get leadership structures', error);
        }
    }
    // Get leadership structure by code
    static async getLeadershipStructureByCode(code) {
        try {
            const query = 'SELECT * FROM leadership_structures WHERE structure_code = ? AND is_active = TRUE';
            return await (0, database_1.executeQuerySingle)(query, [code]);
        }
        catch (error) {
            throw (0, errorHandler_1.createDatabaseError)('Failed to get leadership structure', error);
        }
    }
    // Get leadership structure analytics
    static async getLeadershipStructureAnalytics() {
        try {
            const query = `
        SELECT
          ls.structure_name,
      ...
      `;
            ...
            throw (0, errorHandler_1.createDatabaseError)('Failed to get leadership structure analytics', error);
        }
    }
    // Get all leadership positions with status information
    static async getPositions(hierarchyLevel, entityId) {
        try {
            let query = `
        SELECT
          lp.*,
      ...
      `;
            ...
            throw (0, errorHandler_1.createDatabaseError)('Failed to get leadership positions', error);
        }
    }
    // Get position by ID
    static async getPositionById(id) {
        try {
            ...
            return await (0, database_1.executeQuerySingle)(query, [id]);
        }
        catch (error) {
            throw (0, errorHandler_1.createDatabaseError)('Failed to get leadership position', error);
        }
    }
    // Get current appointments with details
    static async getCurrentAppointments(limit = 20, offset = 0, filters = {}) {
        try {
      ...
      `;
            ...
            throw (0, errorHandler_1.createDatabaseError)('Failed to get current appointments', error);
        }
    }
    // Get appointment history
    static async getAppointmentHistory(limit = 20, offset = 0, filters = {}) {
        try {
      ...
      `;
            ...
            throw (0, errorHandler_1.createDatabaseError)('Failed to get appointment history', error);
        }
    }
    ...
    static async createAppointment(appointmentData) {
      ...
      `;
            ...
            throw (0, errorHandler_1.createDatabaseError)('Failed to create appointment', error);
        }
    }
    // Update appointment
    static async updateAppointment(id, updateData) {
        try {
            ...
            throw (0, errorHandler_1.createDatabaseError)('Failed to update appointment', error);
        }
    }
    ...
    static async getAppointmentById(id) {
      ...
      `;
            ...
            throw (0, errorHandler_1.createDatabaseError)('Failed to get appointment', error);
        }
    }
    // Get appointments count
    static async getAppointmentsCount(filters = {}) {
        try {
            let whereClause = 'WHERE 1=1';
            const params = [];
            if (filters.hierarchy_level) {
            ...
            throw (0, errorHandler_1.createDatabaseError)('Failed to get appointments count', error);
        }
    }
    // Get member's leadership history
    static async getMemberLeadershipHistory(memberId) {
        try {
            const query = `
        SELECT
          la.*,
      ...
      `;
            return await (0, database_1.executeQuery)(query, [memberId]);
        }
        catch (error) {
            throw (0, errorHandler_1.createDatabaseError)('Failed to get member leadership history', error);
        }
    }
    // Check if position is vacant
    static async isPositionVacant(positionId, hierarchyLevel, entityId) {
        try {
            const query = `
      ...
      `;
            const result = await (0, database_1.executeQuerySingle)(query, [positionId, hierarchyLevel, entityId]);
            return (result?.count || 0) === 0;
        }
        catch (error) {
            throw (0, errorHandler_1.createDatabaseError)('Failed to check position vacancy', error);
        }
    }
    // Get leadership structure for an entity
    static async getLeadershipStructure(hierarchyLevel, entityId) {
        try {
            const query = `
        SELECT
      ...
      `;
            return await (0, database_1.executeQuery)(query, [hierarchyLevel, entityId, hierarchyLevel]);
        }
        catch (error) {
            throw (0, errorHandler_1.createDatabaseError)('Failed to get leadership structure', error);
        }
    ...
    static async createElection(electionData) {
      ...
      `;
            ...
            throw (0, errorHandler_1.createDatabaseError)('Failed to create election', error);
        }
    }
    ...
    static async getElections(filters = {}) {
      ...
      `;
            ...
            throw (0, errorHandler_1.createDatabaseError)('Failed to get elections', error);
        }
    }
    // Get election by ID
    static async getElectionById(electionId) {
        try {
            ...
            throw (0, errorHandler_1.createDatabaseError)('Failed to get election by ID', error);
        }
    }
    // Update election status
    static async updateElectionStatus(electionId, status) {
        try {
            const query = `
        ...
        WHERE id = ?
      `;
            const result = await (0, database_1.executeQuery)(query, [status, electionId]);
            return result.affectedRows > 0;
        }
        catch (error) {
            throw (0, errorHandler_1.createDatabaseError)('Failed to update election status', error);
        }
    }
    // Add candidate to election
    static async addCandidate(electionId, memberId, nominationStatement) {
        try {
            const query = `
      ...
      `;
            const result = await (0, database_1.executeQuery)(query, [electionId, memberId, nominationStatement || null]);
            return result.insertId;
        }
        catch (error) {
            throw (0, errorHandler_1.createDatabaseError)('Failed to add candidate', error);
        }
    }
    ...
    static async getElectionCandidates(electionId) {
      ...
      `;
            return await (0, database_1.executeQuery)(query, [electionId]);
        }
        catch (error) {
            throw (0, errorHandler_1.createDatabaseError)('Failed to get election candidates', error);
        }
    }
    // Cast vote
    static async castVote(electionId, candidateId, voterMemberId) {
        try {
            ...
            const existingVote = await (0, database_1.executeQuerySingle)('SELECT id FROM election_votes WHERE election_id = ? AND voter_member_id = ?', [electionId, voterMemberId]);
            if (existingVote) {
        ...
        VALUES (?, ?, ?, NOW())
      `;
            const voteResult = await (0, database_1.executeQuery)(voteQuery, [electionId, candidateId, voterMemberId]);
            // Update candidate vote count
            await (0, database_1.executeQuery)('UPDATE election_candidates SET votes_received = votes_received + 1 WHERE id = ?', [candidateId]);
            // Update total votes cast in election
            await (0, database_1.executeQuery)('UPDATE leadership_elections SET total_votes_cast = total_votes_cast + 1 WHERE id = ?', [electionId]);
            return voteResult.insertId;
        }
        catch (error) {
            throw (0, errorHandler_1.createDatabaseError)('Failed to cast vote', error);
        }
    }
    ...
    static async getElectionResults(electionId) {
      ...
      `;
            ...
            throw (0, errorHandler_1.createDatabaseError)('Failed to get election results', error);
        }
    }
    // Finalize election and declare winner
    static async finalizeElection(electionId) {
        try {
            ...
            // Mark the winner
            await (0, database_1.executeQuery)('UPDATE election_candidates SET is_winner = TRUE WHERE id = ?', [winner.id]);
            ...
            throw (0, errorHandler_1.createDatabaseError)('Failed to finalize election', error);
        }
    }
    // Get eligible voters for an election
    static async getEligibleVoters(hierarchyLevel, entityId) {
        try {
            let query = `
        SELECT
          m.member_id,
      ...
      `;
            ...
            throw (0, errorHandler_1.createDatabaseError)('Failed to get eligible voters', error);
        }
    }
    // ==================== WAR COUNCIL STRUCTURE METHODS ====================
    // Get War Council Structure positions
    static async getWarCouncilPositions() {
        try {
            const query = `
        SELECT
          lp.*,
      ...
      `;
            ...
            throw (0, errorHandler_1.createDatabaseError)('Failed to get War Council positions', error);
        }
    }
    ...
    static async getWarCouncilStructure() {
      ...
      `;
            ...
            throw (0, errorHandler_1.createDatabaseError)('Failed to get War Council structure', error);
        }
    }
    // Check if a War Council position is vacant
    static async isWarCouncilPositionVacant(positionId) {
        try {
            const query = `
        SELECT COUNT(*) as count
        FROM leadership_appointments la
        ...
        WHERE lp.id = ?
          ...
          AND la.entity_id = 1
      `;
            const result = await (0, database_1.executeQuerySingle)(query, [positionId]);
            return result.count === 0;
        }
        catch (error) {
            throw (0, errorHandler_1.createDatabaseError)('Failed to check War Council position vacancy', error);
        }
    }
    // Validate War Council appointment (unique position constraint)
    static async validateWarCouncilAppointment(positionId, memberId) {
        try {
            const errors = [];
      ...
      `;
            const position = await (0, database_1.executeQuerySingle)(positionQuery, [positionId]);
            if (!position) {
        ...
        WHERE la.member_id = ?
          ...
          AND la.entity_id = 1
      `;
            const existingAppointment = await (0, database_1.executeQuerySingle)(existingAppointmentQuery, [memberId]);
            ...
            throw (0, errorHandler_1.createDatabaseError)('Failed to validate War Council appointment', error);
        }
    }
}
exports.LeadershipModel = LeadershipModel;
