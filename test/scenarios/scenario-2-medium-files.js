...
/**
 * Scenario 2: Medium Files Test
 *
 * 10 users uploading medium files (1000-2000 rows)
...
const config = {
  ...
  testFiles: Array(10).fill('member-applications-1000.xlsx')
};
...
async function runTest() {
  console.log(`\n${'='.repeat(80)}`);
  console.log(`🧪 SCENARIO 2: MEDIUM FILES TEST`);
  console.log(`   ${CONCURRENT_USERS} users uploading medium files (1000 rows each)`);
  ...
  console.log(`\n✅ Expected: Queue manages load effectively, smooth processing`);
  console.log(`${'='.repeat(80)}\n`);
}
