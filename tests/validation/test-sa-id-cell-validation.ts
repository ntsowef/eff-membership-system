 ...
 * 
 * Run with: npx ts-node tests/validation/test-sa-id-cell-validation.ts
 */
...
const idTestCases = [
  { id: '8001015009087', expected: true, description: 'Valid ID number' },
  { id: '9202204720082', expected: true, description: 'Valid ID number (female)' },
  { id: '7106245929081', expected: true, description: 'Valid ID number (old)' },
  ...
  { id: '3001015009087', expected: false, description: 'Future date (2030)' },
